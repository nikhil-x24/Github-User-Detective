...
// Functions
// await-> jab tk fetch nhi hoga tb tak kuch v niche ka code execute nhi hoga
// then-> jab tk promise nhi goha tb tak then ke andr wala code execute nhi hoga
// promise ke 2 state -> resolve and reject
